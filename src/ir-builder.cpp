...
BasicBlockRef IRBuilder::findBB(size_t index) {
...
void IRBuilder::setLoopJumps(BasicBlockRef next_bb, BasicBlockRef body_end_bb,
...
BBResult IRBuilder::buildBasicBlock(BytecodeRef byte_code, BasicBlockRef bb,
...
void IRBuilder::buildBasicBlocks(BytecodeRef byte_code) {
